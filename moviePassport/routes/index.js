...
router.get("/", function(req, res, next) {
  // This is our user object as sent back to us by GitHub.
  console.log("User info please!");
  console.log(req.user); // Passport related
...
// After req.user session is set it is now available everywhere.
router.get("/favorites", (req, res) => {
  res.json(req.user.displayName);
});

// After user authorizes GitHub to share the user's profile it goes to this site that we specified.
// We now have to call passport.authenticate('github', {successRedirect, failureRedirect} )
router.get(
  "/auth",
